...
2. Add your code from the **interrupts** module to your new code. Implement logic such that if the pause button has been pressed (interrupt button from **interrupts** module), the displayed timer stops progressing. One the pause button is pressed again, the timer should resume. 