...
ARCHITECTURE structure OF beginner_top IS
...
SIGNAL \ACT1|LED[1]~0_combout\ : std_logic;
SIGNAL \SW[5]~input_o\ : std_logic;
SIGNAL \SW[7]~input_o\ : std_logic;
SIGNAL \SW[4]~input_o\ : std_logic;
SIGNAL \SW[6]~input_o\ : std_logic;
SIGNAL \ACT2|HEX0[0]~0_combout\ : std_logic;
SIGNAL \ACT2|HEX0[2]~1_combout\ : std_logic;
SIGNAL \ACT2|HEX0[4]~2_combout\ : std_logic;
SIGNAL \ACT2|HEX0[0]~3_combout\ : std_logic;
SIGNAL \ACT2|HEX0[6]~4_combout\ : std_logic;
SIGNAL \ACT3|Mux0~0_combout\ : std_logic;
SIGNAL \ACT3|Mux0~1_combout\ : std_logic;
SIGNAL \ACT3|Mux0~2_combout\ : std_logic;
SIGNAL \ACT1|LED\ : std_logic_vector(1 DOWNTO 0);
SIGNAL \ACT1|ALT_INV_LED[1]~0_combout\ : std_logic;
...
ww_devclrn <= devclrn;
ww_devpor <= devpor;
\ACT1|ALT_INV_LED[1]~0_combout\ <= NOT \ACT1|LED[1]~0_combout\;
...
-- pragma translate_on
PORT MAP (
	i => \ACT1|ALT_INV_LED[1]~0_combout\,
	devoe => ww_devoe,
	o => ww_HEX1(6));
...
\ACT1|LED[0]\ : cyclonev_lcell_comb
-- Equation(s):
-- \ACT1|LED\(0) = ( \SW[0]~input_o\ & ( \SW[1]~input_o\ & ( \SW[2]~input_o\ ) ) ) # ( !\SW[0]~input_o\ & ( \SW[1]~input_o\ & ( !\SW[2]~input_o\ ) ) ) # ( \SW[0]~input_o\ & ( !\SW[1]~input_o\ & ( !\SW[2]~input_o\ ) ) ) # ( !\SW[0]~input_o\ & ( 
...
-- Location: LABCELL_X59_Y1_N33
\ACT1|LED[1]~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \ACT1|LED[1]~0_combout\ = ( \SW[0]~input_o\ & ( \SW[1]~input_o\ ) ) # ( !\SW[0]~input_o\ & ( \SW[1]~input_o\ & ( \SW[2]~input_o\ ) ) ) # ( \SW[0]~input_o\ & ( !\SW[1]~input_o\ & ( \SW[2]~input_o\ ) ) )
...
\ACT2|HEX0[0]~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \ACT2|HEX0[0]~0_combout\ = ( \SW[4]~input_o\ & ( \SW[6]~input_o\ ) ) # ( \SW[4]~input_o\ & ( !\SW[6]~input_o\ ) ) # ( !\SW[4]~input_o\ & ( !\SW[6]~input_o\ & ( (!\SW[5]~input_o\ & \SW[7]~input_o\) ) ) )
...
PORT MAP (
	...
	combout => \ACT2|HEX0[0]~0_combout\);

-- Location: MLABCELL_X60_Y1_N54
\ACT2|HEX0[2]~1\ : cyclonev_lcell_comb
-- Equation(s):
-- \ACT2|HEX0[2]~1_combout\ = ( !\SW[4]~input_o\ & ( \SW[5]~input_o\ ) )
...
PORT MAP (
	...
	combout => \ACT2|HEX0[2]~1_combout\);

-- Location: MLABCELL_X60_Y1_N48
\ACT2|HEX0[4]~2\ : cyclonev_lcell_comb
-- Equation(s):
-- \ACT2|HEX0[4]~2_combout\ = ( \SW[4]~input_o\ & ( \SW[6]~input_o\ ) ) # ( !\SW[4]~input_o\ & ( \SW[6]~input_o\ & ( !\SW[5]~input_o\ ) ) ) # ( \SW[4]~input_o\ & ( !\SW[6]~input_o\ ) ) # ( !\SW[4]~input_o\ & ( !\SW[6]~input_o\ & ( (\SW[7]~input_o\ & 
-- !\SW[5]~input_o\) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0011000000110000111111111111111111110000111100001111111111111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	...
	datae => \ALT_INV_SW[4]~input_o\,
	dataf => \ALT_INV_SW[6]~input_o\,
	combout => \ACT2|HEX0[4]~2_combout\);

-- Location: MLABCELL_X60_Y1_N18
\ACT2|HEX0[0]~3\ : cyclonev_lcell_comb
-- Equation(s):
-- \ACT2|HEX0[0]~3_combout\ = ( \SW[4]~input_o\ & ( \SW[6]~input_o\ ) ) # ( !\SW[4]~input_o\ & ( \SW[6]~input_o\ ) ) # ( \SW[4]~input_o\ & ( !\SW[6]~input_o\ ) ) # ( !\SW[4]~input_o\ & ( !\SW[6]~input_o\ & ( \SW[5]~input_o\ ) ) )
...
PORT MAP (
	...
	datae => \ALT_INV_SW[4]~input_o\,
	dataf => \ALT_INV_SW[6]~input_o\,
	combout => \ACT2|HEX0[0]~3_combout\);

-- Location: MLABCELL_X60_Y1_N39
\ACT2|HEX0[6]~4\ : cyclonev_lcell_comb
-- Equation(s):
-- \ACT2|HEX0[6]~4_combout\ = ( \SW[4]~input_o\ & ( \SW[6]~input_o\ ) ) # ( \SW[4]~input_o\ & ( !\SW[6]~input_o\ ) ) # ( !\SW[4]~input_o\ & ( !\SW[6]~input_o\ & ( (!\SW[5]~input_o\ & !\SW[7]~input_o\) ) ) )
...
PORT MAP (
	...
	datae => \ALT_INV_SW[4]~input_o\,
	dataf => \ALT_INV_SW[6]~input_o\,
	combout => \ACT2|HEX0[6]~4_combout\);

-- Location: LABCELL_X59_Y1_N48
\ACT3|Mux0~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \ACT3|Mux0~0_combout\ = ( !\SW[0]~input_o\ & ( \SW[1]~input_o\ & ( !\SW[2]~input_o\ ) ) ) # ( \SW[0]~input_o\ & ( !\SW[1]~input_o\ & ( !\SW[2]~input_o\ ) ) ) # ( !\SW[0]~input_o\ & ( !\SW[1]~input_o\ & ( \SW[2]~input_o\ ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0011001100110011110011001100110011001100110011000000000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	datab => \ALT_INV_SW[2]~input_o\,
	datae => \ALT_INV_SW[0]~input_o\,
	dataf => \ALT_INV_SW[1]~input_o\,
	combout => \ACT3|Mux0~0_combout\);

-- Location: LABCELL_X59_Y1_N45
\ACT3|Mux0~1\ : cyclonev_lcell_comb
-- Equation(s):
-- \ACT3|Mux0~1_combout\ = ( \SW[0]~input_o\ & ( \SW[1]~input_o\ & ( !\SW[2]~input_o\ ) ) ) # ( !\SW[0]~input_o\ & ( \SW[1]~input_o\ & ( \SW[2]~input_o\ ) ) ) # ( \SW[0]~input_o\ & ( !\SW[1]~input_o\ & ( \SW[2]~input_o\ ) ) )
...
PORT MAP (
	...
	datae => \ALT_INV_SW[0]~input_o\,
	dataf => \ALT_INV_SW[1]~input_o\,
	combout => \ACT3|Mux0~1_combout\);

-- Location: LABCELL_X59_Y1_N36
\ACT3|Mux0~2\ : cyclonev_lcell_comb
-- Equation(s):
-- \ACT3|Mux0~2_combout\ = ( \SW[0]~input_o\ & ( \SW[1]~input_o\ ) ) # ( !\SW[0]~input_o\ & ( \SW[1]~input_o\ ) ) # ( \SW[0]~input_o\ & ( !\SW[1]~input_o\ ) ) # ( !\SW[0]~input_o\ & ( !\SW[1]~input_o\ & ( \SW[2]~input_o\ ) ) )
